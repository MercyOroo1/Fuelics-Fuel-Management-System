...
def main():
    ...
    while True:
        ...
        print("6. Get all products supplied by a specific supplier")
        print("7. Get all retailers served by a specific supplier")
        print("8. Get all suppliers that supply a specific product")
